...
export const QUIZ_CATALOG = [
  ...
  {
    key: 'onepiece',
    title: 'Which One Piece Character Are You?',
    quizName: 'One Piece Crew Quiz',
    emoji: '🏴‍☠️',
    category: 'pop',
    description: 'Captain, swordsman, navigator, or marine — find the One Piece character who matches you.',
    time: '~3 min',
  ...
  },
  {
    ...
    quizName: 'Disney Character Quiz',
    emoji: '🏰',
    category: 'pop',
    description: 'Hero, rebel, dreamer, or villain — find the animated character who shares your heart.',
    time: '~3 min',
  ...
  },
  {
    ...
    quizName: 'Pokémon Quiz',
    emoji: '⚡',
    category: 'pop',
    description: 'From cuddly to legendary — which iconic Pokémon would choose you back?',
    time: '~3 min',
